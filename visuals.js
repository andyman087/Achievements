        ...
        const subCategoriesHtml = category.subCategories.map(subCategory => {
            const achievementsHtml = subCategory.achievements.map(achievement => {
                ...
                return `<div class="achievement">
                            ...
                            <div class="achievement-progress">Progress: ${achievement.highlightValue} / ${(achievement.criteria[achievement.highlight] && achievement.criteria[achievement.highlight].min) || achievement.count}</div>
                        </div>`;
            }).join('');
            return `<div>
