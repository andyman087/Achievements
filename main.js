(function() {
    ...
    async function displayAchievementsPage() {
        const user_data = await dataModule.fetchAllStats();
        const processedData = dataModule.processData(user_data);
        const consecutiveDays = dataModule.calculateConsecutiveDays(processedData);
        ...
        visualsModule.createAchievementsPopup(mappedResults, totalValue);
    }
